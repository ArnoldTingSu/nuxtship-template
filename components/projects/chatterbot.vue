<template>
  <div
    class="bg-gradient-to-r from-sky-600 to-emerald-600 px-20 py-20 mt-20 mx-auto max-w-5xl rounded-lg flex flex-col items-center text-center"
  >
    <h2 class="text-white text-3xl md:text-6xl">ChatterBOX</h2>
